package br.com.administradorfiaplanches.infra.exception;

import br.com.administradorfiaplanches.infra.exception.handler.AdministratorBusinessException;
import br.com.administradorfiaplanches.infra.exception.handler.BadRequestException;
...
@ControllerAdvice(basePackages = "br.com.administradorfiaplanches.infra.rest")
public class ExceptionController {
    ...
    @ExceptionHandler(AdministratorBusinessException.class)
    public ResponseEntity<MessageDefaultExceptionHandler> handlerBadRequestException(AdministratorBusinessException exception) {
        return new ResponseEntity<>(
                new MessageDefaultExceptionHandler(
                        exception.getMessage(),
                        HttpStatus.BAD_REQUEST.value(),
